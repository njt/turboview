...
func TestBorlandCyanAllFieldsSet(t *testing.T) {
	...
	if nonZeroCount != 38 {
		t.Errorf("BorlandCyan: expected 38 non-zero fields, got %d", nonZeroCount)
	}
}
...
func TestBorlandGrayAllFieldsSet(t *testing.T) {
	...
	if nonZeroCount != 38 {
		t.Errorf("BorlandGray: expected 38 non-zero fields, got %d", nonZeroCount)
	}
}
...
func TestMatrixAllFieldsSet(t *testing.T) {
	...
	if nonZeroCount != 38 {
		t.Errorf("Matrix: expected 38 non-zero fields, got %d", nonZeroCount)
	}
}
...
func TestC64AllFieldsSet(t *testing.T) {
	...
	if nonZeroCount != 38 {
		t.Errorf("C64: expected 38 non-zero fields, got %d", nonZeroCount)
	}
}
