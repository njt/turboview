...
func TestBorlandBlueHas37NonZeroFields(t *testing.T) {
	...
	if count != 37 {
		t.Errorf("BorlandBlue: expected 37 non-zero fields, got %d", count)
	}
}
...
func TestBorlandCyanHas35NonZeroFields(t *testing.T) {
	...
	if count != 35 {
		t.Errorf("BorlandCyan: expected 35 non-zero fields, got %d", count)
	}
}
...
func TestBorlandGrayHas35NonZeroFields(t *testing.T) {
	...
	if count != 35 {
		t.Errorf("BorlandGray: expected 35 non-zero fields, got %d", count)
	}
}
...
func TestC64Has35NonZeroFields(t *testing.T) {
	...
	if count != 35 {
		t.Errorf("C64: expected 35 non-zero fields, got %d", count)
	}
}
...
func TestMatrixHas35NonZeroFields(t *testing.T) {
	...
	if count != 35 {
		t.Errorf("Matrix: expected 35 non-zero fields, got %d", count)
	}
}
